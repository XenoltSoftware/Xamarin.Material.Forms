...
[assembly: ExportRenderer(typeof(TextArea), typeof(Xamarin.Material.Forms.iOS.Renderers.TextAreaRenderer))]
    ...
    public class TextAreaRenderer : ViewRenderer<TextArea, UITextView>
    {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == TextArea.TextProperty.PropertyName)
                ...
                UpdatePlaceholderColor();
            else if (e.PropertyName == TextArea.AutoSizeProperty.PropertyName)
                UpdateAutoSizeOption();
        }

        void HandleChanged(object sender, EventArgs e)
        {
            ElementController.SetValueFromRenderer(TextArea.TextProperty, Control.Text);
        }
        ...
        void UpdateKeyboard()
        {
            ...
            if (!(keyboard is Xamarin.Forms.Internals.CustomKeyboard))
            {
                ...
                if (Element.IsSet(TextArea.IsTextPredictionEnabledProperty))
                {
