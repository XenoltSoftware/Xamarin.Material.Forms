...
[assembly:ExportRenderer(typeof(Xamarin.Material.Forms.NavigationPage), typeof(Xamarin.Material.Forms.iOS.Renderers.NavigationPageRenderer))]
namespace Xamarin.Material.Forms.iOS.Renderers
{
    public class NavigationPageRenderer : MaterialComponents.AppBarNavigationController, IVisualElementRenderer, IEffectControlProvider
    {
        ...
        Xamarin.Forms.NavigationPage NavPage => Element as Xamarin.Forms.NavigationPage;
...
#pragma warning restore 0618
        ...
        void UpdateCurrentPagePreferredStatusBarUpdateAnimation()
        {
            ...
            PageUIStatusBarAnimation animation = Xamarin.Forms.PlatformConfiguration.iOSSpecific.Page.PreferredStatusBarUpdateAnimation(((Page)Element).OnThisPlatform());
            Xamarin.Forms.PlatformConfiguration.iOSSpecific.Page.SetPreferredStatusBarUpdateAnimation(Current.OnThisPlatform(), animation);
        }

        void UpdateUseLargeTitles()
        {
            if (FormsHelper.IsiOS11OrNewer && NavPage != null)
        ...
        void InsertPageBefore(Page page, Page before)
        {
            ...
            var target = Xamarin.Forms.Platform.iOS.Platform.GetRenderer(before).ViewController.ParentViewController;
        ...
        void UpdateBarTextColor()
        {
            ...
            NavigationBar.TintColor = barTextColor == Color.Default || statusBarColorMode == Xamarin.Forms.PlatformConfiguration.iOSSpecific.StatusBarTextColorMode.DoNotAdjust
        ...
        void SetStatusBarStyle()
        {
            ...
            if (statusBarColorMode == Xamarin.Forms.PlatformConfiguration.iOSSpecific.StatusBarTextColorMode.DoNotAdjust || barTextColor.Luminosity <= 0.5)
            {
...
#pragma warning restore 0618
        ...
        {
            readonly WeakReference<NavigationPageRenderer> _navigation;

            Page _child;
            ToolbarTracker _tracker = new ToolbarTracker();

            public ParentingViewController(NavigationPageRenderer navigation)
            {
                AutomaticallyAdjustsScrollViewInsets = false;

                _navigation = new WeakReference<NavigationPageRenderer>(navigation);
            }
            ...
            internal void UpdateTitleArea(Page page)
            {
                ...
                if (!FormsHelper.IsiOS11OrNewer && !isBackButtonTextSet)
                    backButtonText = "";
            ...
            void UpdateHasBackButton()
            {
                ...
                if (!FormsHelper.IsiOS11OrNewer || n._parentMasterDetailPage != null)
                    UpdateTitleArea(Child);
            }
            ...
            {
                var page = Child;
                if (page != null && FormsHelper.IsiOS11OrNewer)
                {
                    var largeTitleDisplayMode = page.OnThisPlatform().LargeTitleDisplay();
                    switch (largeTitleDisplayMode)
                    {
                        case Xamarin.Forms.PlatformConfiguration.iOSSpecific.LargeTitleDisplayMode.Always:
                            NavigationItem.LargeTitleDisplayMode = UINavigationItemLargeTitleDisplayMode.Always;
                            break;
                        case Xamarin.Forms.PlatformConfiguration.iOSSpecific.LargeTitleDisplayMode.Automatic:
                            NavigationItem.LargeTitleDisplayMode = UINavigationItemLargeTitleDisplayMode.Automatic;
                            break;
                        case Xamarin.Forms.PlatformConfiguration.iOSSpecific.LargeTitleDisplayMode.Never:
            ...
            public override async void DidMoveToParentViewController(UIViewController parent)
            {
                ...
                if (parent == null)
                {
                    NavigationPageRenderer navRenderer;
    ...
    public class AppBarDelegate : MaterialComponents.AppBarNavigationControllerDelegate
    {
        public override void WillAddAppBarViewController(AppBarNavigationController navigationController, AppBarViewController appBarViewController, UIViewController viewController)
        {
            appBarViewController.HeaderView.BackgroundColor = UIColor.Red;
