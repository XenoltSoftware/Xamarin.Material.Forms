...
[assembly: ExportRenderer(typeof(Xamarin.Forms.NavigationPage), typeof(Xamarin.Material.Forms.iOS.Renderers.TestRenderer))]
namespace Xamarin.Material.Forms.iOS.Renderers
{
    public class TestRenderer : UINavigationController, IVisualElementRenderer, IEffectControlProvider
    {
        ...
        public TestRenderer() : base(typeof(FormsNavigationBar), null)
        {
        ...
        protected virtual async Task<bool> OnPushAsync(Page page, bool animated)
        {
            ...
            pack = CreateViewControllerForPage(page);
            var task = GetAppearedOrDisappearedTask(page);
...
#pragma warning restore 0618
        ...
        {
            readonly WeakReference<TestRenderer> _navigation;

            Page _child;
            ToolbarTracker _tracker = new ToolbarTracker();

            public ParentingViewController(TestRenderer navigation)
            {
                AutomaticallyAdjustsScrollViewInsets = false;

                _navigation = new WeakReference<TestRenderer>(navigation);
            }
